...
class ItcastSpider(scrapy.Spider):
    ...
    start_urls = ["https://dblp.uni-trier.de/db/journals/?prefix=I"]#开始的URL
    ...
    def parseInfo(self,response):
        ...
        # #https://ieeexplore.ieee.org/rest/document/8648348/references
        # #https://ieeexplore.ieee.org/rest/document/8648348/toc
        # #https://ieeexplore.ieee.org/rest/document/8648348/similar
        #
        # item['pdf_link'] = response.xpath("//div[class='u-mb-1']/div/text()")
        # print(item)
        #
        pass
